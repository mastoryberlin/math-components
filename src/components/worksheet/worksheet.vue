...
<script>
import { MastoryGeogebra, Formula, MapGeogebra } from "../";

export default {
  name: "Worksheet",
  components: { MastoryGeogebra, Formula, MapGeogebra },
  props: {
    template: {
      type: String,
      default: "<div/>",
  ...
  computed: {
    WorksheetComponent() {
      ...
      return {
        ...options,
        components: { ...components, MastoryGeogebra, Formula, MapGeogebra },
